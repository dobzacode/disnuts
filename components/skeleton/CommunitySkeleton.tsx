...
export default function CommunitySkeleton() {
  return (
    <div
      className={`brutalism-border primary-hover dark:primary-hover-dark peer flex h-[8.2rem] w-full animate-pulse  items-center justify-between rounded-small border-primary80  dark:border-primary1 dark:bg-primary90 `}
    >
